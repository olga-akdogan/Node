...
{
    /// <inheritdoc />
    public partial class InitieleStructuur : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthLatitude = table.Column<decimal>(type: "decimal(9,6)", nullable: true),
                    BirthLongitude = table.Column<decimal>(type: "decimal(9,6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "CookieConsentLogs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    HasAcceptedCookies = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CookieConsentLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CookieConsentLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompatibilityExplanation = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BirthMomentUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SwiperUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Swipes_AspNetUsers_SwiperUserId",
                        column: x => x.SwiperUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Swipes_AspNetUsers_TargetUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NatalChartId = table.Column<int>(type: "int", nullable: false),
                    Body = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Sign = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    House = table.Column<int>(type: "int", nullable: false),
                    DegreeInSign = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Placements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Placements_NatalCharts_NatalChartId",
                        column: x => x.NatalChartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CookieConsentLogs_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Placements_NatalChartId_Body",
                table: "Placements",
                columns: new[] { "NatalChartId", "Body" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Swipes_SwiperUserId_TargetUserId",
                table: "Swipes",
